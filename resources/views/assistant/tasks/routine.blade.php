...
@section('title', 'Tugas Rutin')
@section('page-title', 'Tugas Rutin')
@section('page-subtitle', 'Tugas harian yang di-generate otomatis hari ini')
...
<div class="flex items-center justify-between mb-6">
    <p class="text-sm text-gray-500">
        Total: <span class="font-semibold text-gray-700">{{ $tasks->count() }}</span> tugas rutin
    </p>
</div>
            ...
            @empty
                <tr>
                    <td colspan="4" class="px-6 py-12 text-center text-gray-400 text-sm">
                        Tidak ada tugas rutin hari ini.
                    </td>
                </tr>
            @endforelse
        </tbody>
...
<script>
    function openCompleteModal(id, title) {
        ...
        document.getElementById('form-complete').action = `/assistant/tasks/routine/${id}/complete`;
